...
final class InvoiceDetailsController extends AbstractController
{
                        ...
                        ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $invoiceDetail->setCompany($invoice->getCompany());
    ...
    #[Route('/{uuid}/{reference}/edit/{id}', name: 'app_invoice_details_edit', methods: ['GET', 'POST'])]
    public function edit(
        ...
        if ($uuid !== (string) $invoice->getCompany()->getUuid() || $invoiceDetail->getInvoice() !== $invoice) {
            throw $this->createAccessDeniedException();
        }
    ...
    #[Route('/{uuid}/{reference}/delete/{id}', name: 'app_invoice_details_delete', methods: ['POST'])]
